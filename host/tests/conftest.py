...
#
# Never created: nothing here writes scheduler state, and a directory that
# does not exist cannot acquire one. The explicit overrides go too — setting
...
os.environ["SCHEDULER_HOME"] = str(
    Path(tempfile.gettempdir()) / "jstack-host-tests-no-scheduler-install")
